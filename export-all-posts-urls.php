...
add_action('admin_menu', 'sh_post_check_admin_menu');
 
function sh_post_check_admin_menu(){
    add_menu_page( 'Export Posts', 'Export Posts/Pages', 'manage_options', 'export-post-setting-page', 'sh_export_post_setting' );
}
function sh_export_post_setting(){

    include(plugin_dir_path(__FILE__) . 'sh-export-post-settings.php');

}
function sh_exportall_posts_urls_on_activate() {
...
register_activation_hook( __FILE__, 'sh_exportall_posts_urls_on_activate' );
function sh_redirect_on_exportall_posts_urls_activation() {
...
add_action( 'admin_init', 'sh_redirect_on_exportall_posts_urls_activation' );
...
add_filter( 'admin_footer_text', 'sh_admin_footer_text' );

function sh_admin_footer_text( $footer_text ) {
